...
describe("SELL FREE TOKEN", async () => {
  it(`Sell Free Token`, async () => {
    ...
    const MOCKED_TOKEN_METADATA = {
      ...
      hash: "u38iaK32y64542344JzAjJh34j2346",
    };
    const FREE_TOKEN_SELLER = anchor.web3.Keypair.generate();
    ...
    const fees = await sellFreeToken.runTest(
      LOCALNET_CONFIG,
      MOCKED_TOKEN_METADATA,
      FREE_TOKEN_SELLER,
      false,
  ...
  it(`Claimed Free Token > Sell Free Token`, async () => {
    /* Start Setup */
    const BUYER = anchor.web3.Keypair.generate();
    const MOCKED_TOKEN_METADATA = {
      name: "Test Token 1",
      symbol: "TESTO",
      uri: "https://5vfxc4tr6xoy23qefqbj4qx2adzkzapneebanhcalf7myvn5gzja.arweave.net/7UtxcnH13Y1uBCwCnkL6APKsge0hAgacQFl-zFW9NlI",
      hash: "u38iaKy645434232344JzQjJh34j2346",
    };
    const FREE_TOKEN_SELLER = anchor.web3.Keypair.generate();
    const OPERATOR = anchor.web3.Keypair.generate();
