...
import * as unlockInitialSupplyTokenExponential from "../transactions/exponential.unlock_initial_supply_token";
...
describe("UNLOCK INITIAL SUPPLY AMOUNT", async () => {
  it(`Create Token -> Claim Initial Token -> Unlock Initial Token`, async () => {
    /* Start Setup */
    const MOCKED_TOKEN_METADATA = {
      name: "Test Token 1",
      symbol: "TESTO",
      uri: "https://5vfxc4tr6xoy23qefqbj4qx2adzkzapneebanhcalf7myvn5gzja.arweave.net/7UtxcnH13Y1uBCwCnkL6APKsge0hAgacQFl-zFW9NlI",
      hash: "u38iaKy63260rIg8LJzCjJh34jPfxDu",
    };
    const KNOWLEDGE_OWNER = anchor.web3.Keypair.generate();
    const OPERATOR = anchor.web3.Keypair.generate();
    /* End Setup */

    const fees = await unlockInitialSupplyTokenExponential.runTest(
      LOCALNET_CONFIG,
  ...
  it(`Claim Initial Token -> Unlock Initial Token`, async () => {
    /* Start Setup */
    ...
    const MOCKED_TOKEN_METADATA = {
      ...
      symbol: "TESTO",
      uri: "https://5vfxc4tr6xoy23qefqbj4qx2adzkzapneebanhcalf7myvn5gzja.arweave.net/7UtxcnH13Y1uBCwCnkL6APKsge0hAgacQFl-zFW9NlI",
      hash: "u38ia43y660rIg8LJzCjJh34jPfxD1",
    };
    const KNOWLEDGE_OWNER = anchor.web3.Keypair.generate();
    const OPERATOR = anchor.web3.Keypair.generate();
  ...
  it(`Unlock Initial Token`, async () => {
    ...
    const MOCKED_TOKEN_METADATA = {
      ...
      symbol: "TESTO",
      uri: "https://5vfxc4tr6xoy23qefqbj4qx2adzkzapneebanhcalf7myvn5gzja.arweave.net/7UtxcnH13Y1uBCwCnkL6APKsge0hAgacQFl-zFW9NlI",
      hash: "u38iaKy660rIg8LJzCjJh34jPfxD5",
    };
    const KNOWLEDGE_OWNER = anchor.web3.Keypair.generate();
    const OPERATOR = anchor.web3.Keypair.generate();
    ...
    await claimInitialSupplyTokenExponential.runTest(
      LOCALNET_CONFIG,
      MOCKED_TOKEN_METADATA,
      KNOWLEDGE_OWNER,
      MARKETPLACE_OWNER
